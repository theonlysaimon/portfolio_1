...
.STACK 256
.DATA
MYTEXT DB "Seb ut perspiciatis unde OMNIS ISTE NATUS ERROR SIT", 13, 10, '$' ;объявляем текстовую 
					;переменную
...
NOP		;ничего
ADD AH, 20h	;преобразование символа
...
CMP AH, 41h	;сравнение значения AH с 41h
JB MT2		;при выполнении условия перейти к MT2 (если AH = значению)
CMP AH, 5Ah	;сравнение значения AH с 5Ah
