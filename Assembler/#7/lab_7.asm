...
NOP		;ничего
AND AH, 20h	;логическая инструкция and между AH и значением 0DFh
...
;---------------------------------начало тела цикла----------------------------------
MT1: 
MOV AH, [BX]	;перемещение значения ссылки BX в AH
CMP AH, 61h	;сравнение значения AH с 61h
JB MT2		;при выполнении условия перейти к MT2 (если AH = 61h)
CMP AH, 7Ah	;сравнение значения AH с 7Ah 
JA MT2		;при выполнении условия перейти к MT2 (если AH = 7A)
