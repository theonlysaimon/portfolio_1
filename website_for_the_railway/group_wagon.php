...
$result = mysqli_query($conn, "SELECT group_wagon.id_group_wagon, locomotive.serial_numbe, type_loc, type_wag, count_wagon, number_seats 
FROM train INNER JOIN locomotive ON locomotive.id_locomotive = train.locomotive_id 
INNER JOIN group_wagon ON group_wagon.train_id = train.id_train 
INNER JOIN wagon ON wagon.id_wagon = group_wagon.wagon_id");
