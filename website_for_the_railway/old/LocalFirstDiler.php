...
$result = mysqli_query($conn, "SELECT * FROM `дилеры`,`фотографии` WHERE `Фотография`=`фотографии`.`ID_фотографии`");
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="iner-titel">
                                        <h5>
                                            <?php echo $row["Фамилия"]." ".$row["Имя"]." ".$row["Отчество"] ?>
                                        </h5>
                                    </div>
                                    <div class="iner-text">
                                        <p>
                                            <?php
                                            echo "Адрес: " . $row["Домашний_адрес"] . "<br> Номер: " . $row["Телефон"];
                                            ?>
                                        </p>
                                    </div>
                                    <div class="iner-ancro">
                                        <form class="form_changes_2" action="LocalDeleteDiler.php" method="POST">
                                            <input class="form__input_2" placeholder=" " type="text" name="ID_дилера"
                                                   value="<?php echo $row['ID_дилера'];  ?>">
