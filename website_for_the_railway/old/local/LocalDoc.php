                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="iner-titel">
                                    <h5>
                                        <?php echo "Договор №" .$row["ID_договора"] ?>
                                    </h5>
                                </div>
                                <div class="iner-text">
                                    <p>
                                        <?php
                                        echo "Клиент №" . $row["ID_клиента"] . ", Автомобиль №" . $row["ID_машины"] . ", Дилер №" . $row["ID_дилера"]. "<br> Дата заключения: " . $row["Дата_продажи"]. "<br> Цена: " . $row["Цена_продажи"]. " руб <br>Примечания: " . $row["Примечания"];
                                        ?>
                                    </p>
                                </div>
                                <div class="iner-ancro">
                                    <form class="form_changes_2" action="DeleteDoc.php" method="POST">
                                        <input class="form__input_2" placeholder=" " type="text" name="ID_договора"
                                               value="<?php echo $row['ID_договора'];  ?>">
                                        <button class="form__button_2" type="submit" name="delete_doc">Удалить</button>
                                    </form>
                                </div>
                            </div>
                        </div>
