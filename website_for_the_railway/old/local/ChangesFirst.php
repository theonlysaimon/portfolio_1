...
<form class="form_changes" action="LocalСustomers.php" method="POST">
    <h1 class="form__title">Добавить клиента</h1>

    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Фамилия">
        <label class="form__label">Фамилия</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Имя">
        <label class="form__label">Имя</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Отчество">
        <label class="form__label">Отчество</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Город">
        <label class="form__label">Город</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Адрес">
        <label class="form__label">Адрес</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Контактный_телефон">
        <label class="form__label">Контактный телефон</label>
    </div>
    <button class="form__button" type="submit" name="send">Добавить</button>
</form>
