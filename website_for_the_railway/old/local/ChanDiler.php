...
<form class="form_changes" action="NewDiler.php" method="POST">
    <h1 class="form__title">Добавить дилера</h1>
    ...
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Домашний_адрес">
        <label class="form__label">Адрес</label>
    </div>
    <div class="form__group">
        <input class="form__input" placeholder=" " type="text" name="Телефон">
