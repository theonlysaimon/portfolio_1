...
$result = mysqli_query($conn, "SELECT * FROM `автопарк`,`фотографии` WHERE `фотографии`.`ID_фотографии` = `автопарк`.`Фото_автомобиля`");
                    ...
                    <div class = "col-md-6">
                        <div class="main-iner">
                            <div class="row">
                                <div class="col-4">
                                    <div class="image">
                                        <img src="<?php echo $row["Путь_к_файлу"]?>", alt="">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="iner-titel">
                                        <h5>
                                            <?php echo $row["Марка_автомобиля"] ?>
                                        </h5>
                                    </div>
                                    <div class="iner-text">
                                        <p>
                                            <?php
                                            echo "Регистрационный номер: " . $row["Регистрационный_номер"] . "<br> Дата выпуска: " . $row["Дата_выпуска"];
                                            ?>
                                        </p>
                                    </div>
                                    <div class="iner-ancro">
                                        <form class="form_changes_2" action="DeleteAvto.php" method="POST">
                                            <input class="form__input_2" placeholder=" " type="text" name="ID_машины"
                                                   value="<?php echo $row['ID_машины'];  ?>">
                                            <button class="form__button_2" type="submit" name="delete_dil">Удалить</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
