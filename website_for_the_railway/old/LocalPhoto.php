                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="iner-titel">
                                        <h5>
                                            <?php echo $row["Название"] ?>
                                        </h5>
                                    </div>
                                    <div class="iner-ancro">
                                        <form class="form_changes_2" action="DeletPhoto.php" method="POST">
                                            <input class="form__input_2" placeholder=" " type="text" name="ID_фотографии"
                                                   value="<?php echo $row['ID_фотографии'];  ?>">
